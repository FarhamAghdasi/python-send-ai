...
def interactive_mode():
    ...
    return folder_path, filter_folder, exclude_folders, exclude_extensions, keyword, regex, output_format
...
def main():
    ...
    if args.custom:
        ...
        folder_path, filter_folder, exclude_folders, exclude_extensions, keyword, regex, output_format = interactive_mode()
